...
public class ApplicationConfig {
    ...
    @Bean
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(JpaVendorAdapter jpaVendorAdapter, DataSource dataSource, Properties hibernateProperties) {
